...
def add():
    ...
    add_separator.grid(row=4,column=1,sticky=W)
...
info_label=Label(ventana, text="Información del producto")
data_label=Label(ventana, text="Creado pr Christian Freire - 2026")
